...
import { ShoppingCart, MessageCircle, ShieldCheck, Leaf, Clock, ArrowRight, Star, PackageCheck, Award, CheckCircle2, Sparkles } from 'lucide-react';
import HennaSelfDrawingAnimation from './HennaSelfDrawingAnimation';
    ...
    <div className="bg-white text-gray-900 pt-4 pb-8 sm:pt-6 sm:pb-10 lg:pt-6 lg:pb-12 border-b border-gray-100 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Right Clean Showcase Composition with Live Henna Self-Drawing Animation */}
          <div className="lg:col-span-5 relative flex justify-center">

            <div className="relative w-full max-w-md">

              {/* Main Showcase Container */}
              <div className="aspect-square sm:aspect-[4/5] bg-gradient-to-b from-[#faf6f0] via-[#f7efe5] to-[#f3e7d8] rounded-3xl overflow-hidden border border-amber-200/60 shadow-2xl relative flex flex-col items-center justify-center p-4 sm:p-6 group">
                
                {/* Subtle Decorative Background Glow */}
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-amber-100/40 via-transparent to-transparent pointer-events-none" />

                {/* Live Vector Self-Drawing Henna Mandala Animation */}
                <div className="w-full h-full flex items-center justify-center relative z-0">
                  <HennaSelfDrawingAnimation className="w-full h-full max-h-[380px] max-w-[380px]" />
                </div>
